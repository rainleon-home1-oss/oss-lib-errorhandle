...
public class ResolvedErrorXmlTest {
  ...
  public void testSerializeXmlMapper() throws IOException, JAXBException {
    final String actual = this.xmlMapper.writeValueAsString(ResolvedErrorTestScenario.resolvedErrorScenario());
  ...
  public void testSerializeJaxb2() throws IOException {
    ...
    this.jaxb2Marshaller.marshal(ResolvedErrorTestScenario.resolvedErrorScenario(), new StreamResult(actual));
  ...
  public void testSerializeJAXB() throws IOException {
    final StringWriter actual = new StringWriter();
    JAXB.marshal(ResolvedErrorTestScenario.resolvedErrorScenario(), new StreamResult(actual));
  ...
  private void assertSerialize(final String actual) throws FileNotFoundException {
    ...
    final ResolvedError error = ResolvedErrorTestScenario.resolvedErrorScenario();
